...
완성된 에이전트는 팀즈, 코파일럿에서 외교부에서 제공하는 국가의 현지 정보들을 조회할 수 있고 해당 내용을 메일로 받아볼 수 있습니다.
또한 쉐어포인트, 폼즈와 연동하여 직접 에이전트에 묻지 않더라도 사이트에 정보를 등록하게 될 경우 해당 정보를 토대로 에이전트가 국가 정보를 메일로 전송하게 됩니다.
